...
def get_image():
    ...
    subprocess.run(["libcamera-still", "--autofocus-mode", "continuous", "--hdr", "sensor", "--hflip", "1", "--vflip", "1", "-o", os.path.join(picturedir, "image.jpg")])
...
def main():
    while True:
        ...
        headers = {
            ...
            "token": "uXLd6wF1UUXC0IXcnGIa",  # replace with your token
        }
        
        headersXL = {
            "content-type": "image/jpg",
            "fingerprint": "70da3c685d1b714f587a25b034ca1414171c621d",  # replace with your fingerprint
            "token": "X2YeDni2qgY7ssxUnBQ8",  # replace with your token
        }        
        ...
        while retry:
            try:
                ...
                responseXL = requests.put(url, headers=headersXL, data=snapshot)
